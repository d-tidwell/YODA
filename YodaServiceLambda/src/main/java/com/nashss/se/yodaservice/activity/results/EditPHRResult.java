...
public class EditPHRResult {
    ...
    public EditPHRResult(String patientId, String providerName, String date, String status, String dictationId,
    ...
    public static class Builder{
        ...
        public EditPHRResult build() {return new EditPHRResult(patientId, providerName, date, status, dictationId, transcription, comprehendData);}
